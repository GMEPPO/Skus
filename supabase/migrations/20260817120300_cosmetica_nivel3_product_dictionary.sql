...
dictionary(label, normalized_label, reference_code, designation_pt, designation_es, designation_en, empty_designation, include_in_designation) as (
  ...
  ('Bálsamo Corporal', 'bálsamo corporal', 'BOD', 'Bálsamo Corporal', 'Bálsamo Corporal', 'Body Balm', false, true),
  ...
  ('Gel Corpo Cabelo', 'gel corpo cabelo', 'GCC', 'Gel Corp Cabelo', 'Gel Cuerpo Cabello', 'Hair and Body Gel', false, true),
  ('Gel de Limpeza', 'gel de limpeza', 'GBD', 'Gel Lavant', 'Gel Lavant', 'Gel Lavant', false, true),
