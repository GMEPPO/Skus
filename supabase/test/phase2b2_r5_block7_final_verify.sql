-- ============================================================================
-- FASE 2B.2 R5 — VERIFY instrumentación 7B + SECURITY GATE final (READ ONLY)
-- Esperado:
--   leftover_triggers / leftover_functions = 0 filas
--   security gate: 13/13 passed = true
-- ============================================================================

-- A) Triggers no internos en measurement history
...
-- B) Funciones skus_private de test/sleep/phase2b2/delay (debe quedar vacío)
select
  n.nspname,
  p.proname,
