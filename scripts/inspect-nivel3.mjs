...
const file = "c:\\Users\\mviera\\OneDrive - Groupe GM\\PCsEquipment\\MiguelViera\\Desktop\\Nivel 3.xlsx";
...
for (const name of wb.SheetNames) {
  ...
  if (obsCol) {
    ...
    console.log("\nObs unique:", values.slice(0, 20), values.length > 20 ? `...+${values.length - 20}` : "");
  }
}
