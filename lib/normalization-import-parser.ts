...
const COLUMN_ALIASES: Record<string, keyof Omit<ParsedNormalizationImportRow, "sourceRowNumber" | "normalizationStatus" | "importIssue">> = {
  ...
  designacao_nova: "sourceDesignationPt",
  designacao_nova_pt: "sourceDesignationPt",
  nova_designacao: "sourceDesignationPt",
  nova_designacao_pt: "sourceDesignationPt",
  designacao_pt_nova: "sourceDesignationPt",
  designacao_final: "sourceDesignationPt",
  designacao_pt_final: "sourceDesignationPt",
  designacao_new: "sourceDesignationPt",
  new_designation_pt: "sourceDesignationPt",
  descricao_nova: "sourceDesignationPt",
  descricao_pt: "sourceDesignationPt",
  descricao_pt_nova: "sourceDesignationPt",
  designacao_es: "sourceDesignationEs",
  source_designation_es: "sourceDesignationEs",
  designacao_nova_es: "sourceDesignationEs",
  nova_designacao_es: "sourceDesignationEs",
  designacao_es_nova: "sourceDesignationEs",
  designacao_es_final: "sourceDesignationEs",
  new_designation_es: "sourceDesignationEs",
  descricao_es: "sourceDesignationEs",
  descricao_nova_es: "sourceDesignationEs",
  designacao_en: "sourceDesignationEn",
  source_designation_en: "sourceDesignationEn",
  designacao_nova_en: "sourceDesignationEn",
  nova_designacao_en: "sourceDesignationEn",
  designacao_en_nova: "sourceDesignationEn",
  designacao_en_final: "sourceDesignationEn",
  new_designation_en: "sourceDesignationEn",
  descricao_en: "sourceDesignationEn",
  descricao_nova_en: "sourceDesignationEn",
  estado: "sourceStatus",
  status: "sourceStatus",
